...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/experimental/auth-basic': { kind: 'none', reason: 'The HTTP authentication wrapper completes before the browser reaches DSH RPC or any model-request assembly.' },
  ...
  'packages/client/ui-file-tree': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
