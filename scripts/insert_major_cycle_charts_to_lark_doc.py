#!/usr/bin/env python3
"""Insert major-cycle K-line charts into the Lark report."""
...
MANIFEST_PATH = Path("lab/backtests/sw_sector_balanced_cycle_analysis/kline_charts/chart_manifest.json")
RESULT_PATH = Path("lab/backtests/sw_sector_balanced_cycle_analysis/kline_charts/lark_insert_results.json")
