...
import {
  ...
  workspaceUploadFileValueSchema,
...
export interface IApiClient {
  ...
  workspace: {
    ...
    uploadFile(payload: RequestPayload<'workspace.uploadFile'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'workspace.uploadFile'>>>
  }
  skills: {
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'workspace.uploadFile': workspaceUploadFileValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly workspace: IApiClient['workspace'] = {
    ...
    uploadFile: (payload, signal) => this.callUnary('workspace.uploadFile', payload, signal),
  }
