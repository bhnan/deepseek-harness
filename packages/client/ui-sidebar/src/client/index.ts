...
export type {
  ...
  SidebarFileTreeOwnerProps, SidebarRootComponentProps, SidebarRootInjected, SidebarSectionOwnerProps, SidebarSettingsOwnerProps,
  ...
  ctx.effect(
    () => ctx.slots.register({
      ...
      children: {
        ...
        'sidebar.filetree': { kind: 'single', scope: 'root' },
