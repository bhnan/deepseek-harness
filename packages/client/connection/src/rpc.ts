...
export interface HostConnectionHandle {
  ...
  /**
   * Authenticate one frontend index request, owning a selected-login redirect or 401.
  ...
  /**
   * Select a password-mode clean root or add a fresh process token to an ordinary Web application URL.
