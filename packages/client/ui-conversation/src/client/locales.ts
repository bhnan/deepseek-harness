...
export const zh = {
  ...
  'file.cancel': '取消',
  'file.uploading': '上传中…',
  'file.invalidPath': '上传文件返回的路径无效，请重试',
  'file.uploadFailed': '文件上传失败（{reason}）',
...
export const en = {
  ...
  'file.dropTitle': 'Drag files here to upload them',
  'file.dropDesc': 'Files are saved to the current workspace for the agent to read and parse',
  'file.dropBlocked': 'Files cannot be uploaded right now',
  'file.attach': 'Attach',
  'file.attachDialog': 'Attach a file',
  'file.chooseFile': 'Choose file',
  'file.choosePhotos': 'Choose photos',
  'file.cancel': 'Cancel',
